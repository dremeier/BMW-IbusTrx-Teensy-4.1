...
const byte Key1FunkZu [6] PROGMEM = {0x00, 0x04, 0xBF, 0x72, 0x16, 0xDF};           // FunkSchlüssel Andre zu
const byte cleanIKE [7] PROGMEM = {0x30, 0x05, 0x80, 0x1A, 0x30, 0x00, 0x9F};       // IKE Anzeige wird gelöscht, wichtig sonst bleibt sie immer an
const byte BlinkerRe [14] PROGMEM = {0x3F, 0x0C, 0xD0, 0x0C, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAF};      //3F0FD00C000040000000000000
const byte BlinkerLi [14] PROGMEM = {0x3F, 0x0C, 0xD0, 0x0C, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x6F};     // 3F 0B D0 0C 00 00 80 00 00 00 00 00
const byte BlinkerAus [14] PROGMEM = {0x3F, 0x0C, 0xD0, 0x0C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xEF};    //3F0FD00C000000000000000000
const byte LCMdimmReq [5] PROGMEM ={0x3F, 0x03, 0xD0, 0x0B, 0xE7};                  // Diagnoseanfrage ans LCM um Helligkeitswert für IKE zu finden
#endif
